...
PATH_TEXT_PROMPTS = os.path.join(script_dir, "test_five_planes_prompts.json")
...
class CAMPredictor:
    ...
    def initialize_models(self, model, tokenizer, preprocess):
        """receive already loaded model/tokenizer/preprocess"""
    ...
    def predict_image(self, image_path):
        """generate CAM for an input image"""
